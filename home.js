...
async function getdata(user, searchValue = '') {
...
onAuthStateChanged(auth, (user) => {
    if (user) {
        getdata(user); // Initial load

        searchButton.addEventListener('click', () => {
            const searchValue = searchInput.value.trim();
            getdata(user, searchValue);
        });
        ...
        <h1 class="text-4xl font-bold mb-6 text-start">${selectedProduct.productTitle}</h1>
            <div class="card  card-side bg-base-100 shadow-xl p-4 flex flex-col lg:flex-row">
                <div class="w-full lg:w-[35rem] lg:h-[30rem] mb-4 lg:mb-0">
                    <img src="${selectedProduct.productImageUrl}" class="w-[90%]" alt="Product Image"
            ...
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.172 5.172a4 4 0 015.656 0L12 8.344l3.172-3.172a4 4 0 015.656 5.656L12 21.172l-8.828-8.828a4 4 0 010-5.656z" />
                    ...
                    <div class="bg-blue-500 text-white p-4 rounded-lg mb-4">
                        ...
                        <div class="flex flex-col lg:flex-row justify-between items-center mt-4">
                            <button class="btn btn-grey w-full lg:w-40 mb-2 lg:mb-0">Call Now</button>
                            <a href="#" class="text-white underline">See profile</a>
                        </div>
                    </div>

                    <div class="flex flex-col lg:flex-row w-full justify-between">
                        <div class="w-full lg:w-1/2 mb-2 lg:mb-0">
                            <button class="btn btn-primary w-full px-10">ADD TO CART</button>
                        </div>
                        ...
                        <div class="flex items-center space-x-2 mt-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M12 2C8.7 2 6 4.7 6 8c0 3.3 4.4 7.8 5.6 9.2 1.2-1.4 5.6-5.9 5.6-9.2 0-3.3-2.7-6-6-6zm0 8c-1.1 0-2-1.1-2-2s.9-2 2-2 2 1.1 2 2-.9 2-2 2z" />
                            </svg>
                            <span class="text-sm text-black-600 font-bold">Fb Area Karachi</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card bg-base-100 shadow-xl mt-8 p-4">
